...
class SiteSettingController extends Controller
{
    ...
    public function updateSiteSetting(SiteSettingFormRequest $request)
    {
        ...
        $siteSetting->footer_text = $request->input('footer_text');
        $siteSetting->footer_link = $request->input('footer_link');
        $siteSetting->link_text = $request->input('link_text');
        ...
        $siteSetting->is_stripe_active = $request->input('is_stripe_active');
		    ...
		    $siteSetting->is_employer_package_active = $request->input('is_employer_package_active');
