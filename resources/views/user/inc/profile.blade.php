<h5>{{__('Personal Information')}}</h5>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                @else
                  <div class="formrow"> {{ ImgUploader::print_image(Config::get('app.default_seeker_image'), 100, 100) }} </div>
                @endif
              </div>
              <div class="col-md-6">
                <div class="formrow">
            ...
            <div class="row">
             ...
             {!! Form::select('country_id', [''=>__('Select Country')]+$countries, $country_id, array('class'=>'form-control', 'id'=>'country_id')) !!}
              ...
              <div class="col-md-6">
                <div class="formrow"> {!! Form::text('national_id_card_number', null, array('class'=>'form-control', 'id'=>'national_id_card_number', 'placeholder'=>__('ADHAAR Card#'))) !!}
                  </div>
              </div>
              <div class="col-md-6">
                <div class="formrow"> {!! Form::text('phone', null, array('class'=>'form-control', 'id'=>'phone', 'placeholder'=>__('Phone'))) !!}
                  </div>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-4">
                <div class="formrow"> {!! Form::text('expected_salary', null, array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>__('Expected Salary'))) !!}
                   </div>
              </div>
              <div class="col-md-4">
