...
@include('includes.inner_page_title', ['page_title'=>__('Resume Highlighter')])
...
<div class="inner-page"> 
  ...
  <div class="container">
        <div class="contact-wrap">
            <div class="title"> <span>{{__('Get Resume Highlighter Get Noticed.')}}</span>
            ...
            <div class="contact-now">
                        ...
                        <div class="paypackages"> 
                                ...
                                <div class="four-plan">
                                  ...
                                  <div class="row"> @foreach($serviceData as $services)
                                    @if($services->service_for == "resume_highlighter")
                ...
                <div class="col-md-8 column">
                       <div class="why_resume">
                            <h2 class="why_resume_title">{{__('Why Highlighter')}}</h2>
                            <ul class="why_resume_content">
                                    ...
                                    <li>With Highlighter your profile is showcased as an active jobseeker, who is keenly looking for a job</li>
                                    <li>With Highlighter you stand out from the crowd, thus increasing your chances of getting shortlisted</li>
                                </ul>
                       </div>

                       <div class="why_resume" style="margin: 10px 0 0 0;">
                            <h2 class="why_resume_title">{{__('How Highlighter works?')}}</h2>
                       <p class="service_desc">{{__('Once you subscribe to Highlighter you’ll get an order confirmation. Within 2 working days, you’ll get a mail from us asking for your latest resume. Once you upload your resume, you would be promoted as an active job seeker in the Monster database. Your resume will be listed at the top of search results, thus boosting your chanc es of getting shortlisted. We not only list your resume at the top but showcase your designation, education & experience, skills, industry, function and role you are in so that it grabs the attention of a recruiter.')}}</p>
                       </div>
