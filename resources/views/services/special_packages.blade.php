...
@include('includes.inner_page_title', ['page_title'=>__('Special Packages')])
...
<div class="inner-page"> 
  ...
  <div class="container">
        <div class="contact-wrap">
            <div class="title"> <span>{{__('Get Special Packages Get Noticed.')}}</span>
            ...
            <div class="contact-now">
                        ...
                        <div class="paypackages"> 
                                ...
                                <div class="four-plan">
                                  ...
                                  <div class="row"> @foreach($serviceData as $services)
                                    @if($services->service_for == "special_packages")
                ...
                <div class="col-md-8 column">
                       <div class="why_resume">
                            <h2 class="why_resume_title">{{__('Why Special Packages')}}</h2>
