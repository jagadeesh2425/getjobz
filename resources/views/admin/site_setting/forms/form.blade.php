...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'footer_text') !!}">
        {!! Form::label('footer_text', 'Footer Text', ['class' => 'bold']) !!}
        {!! Form::text('footer_text', null, array('class'=>'form-control', 'id'=>'footer_text', 'placeholder'=>'Powered by')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'footer_text') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'footer_link') !!}">
        {!! Form::label('footer_link', 'Footer Link', ['class' => 'bold']) !!}
        {!! Form::text('footer_link', null, array('class'=>'form-control', 'id'=>'footer_link', 'placeholder'=>'http://www.ecomwebsolutions.com/')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'footer_link') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'link_text') !!}">
        {!! Form::label('link_text', 'Link Text', ['class' => 'bold']) !!}
        {!! Form::text('link_text', null, array('class'=>'form-control', 'id'=>'link_text', 'placeholder'=>'E Com Websolutions')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'link_text') !!}
    </div>
