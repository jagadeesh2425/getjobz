...
<div class="form-body">
    ...
    <fieldset>
    <legend>Employer Packages:</legend>
        <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_employer_package_active') !!}">
            {!! Form::label('is_employer_package_active', 'Is Package active for employer?', ['class' => 'bold']) !!}
            <div class="radio-list">
                <label class="radio-inline">{!! Form::radio('is_employer_package_active', 1, null, ['id' => 'is_employer_package_active_yes']) !!} Yes </label>
                <label class="radio-inline">{!! Form::radio('is_employer_package_active', 0, true, ['id' => 'is_employer_package_active_no']) !!} No </label>
            </div>
            {!! APFrmErrHelp::showErrors($errors, 'is_employer_package_active') !!}
        </div>
    </fieldset>
