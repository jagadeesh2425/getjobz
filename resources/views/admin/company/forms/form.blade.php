...
<div class="form-body">
    <div class="row">
        ...
        <div class="col-md-6">
          ...
          @else
            {{ ImgUploader::print_image(Config::get('app.default_company_logo')) }}
          @endif
        </div>
        @endif
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_featured') !!}">
        ...
        <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_verified') !!}">
            {!! Form::label('is_verified', 'Is Verified?', ['class' => 'bold']) !!}
            <div class="radio-list">
                <?php
                $is_verified_1 = '';
                $is_verified_2 = 'checked="checked"';
                if (old('is_verified', ((isset($company)) ? $company->verified : 0)) == 1) {
                    $is_verified_1 = 'checked="checked"';
                    $is_verified_2 = '';
                }
                ?>
                <label class="radio-inline">
                    <input id="verified" name="is_verified" type="radio" value="1" {{$is_verified_1}}>
                    Verified </label>
                <label class="radio-inline">
                    <input id="not_verified" name="is_verified" type="radio" value="0" {{$is_verified_2}}>
                    Not Verified </label>
            </div>
            {!! APFrmErrHelp::showErrors($errors, 'is_verified') !!} </div>
