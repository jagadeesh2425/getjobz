        ...
        <div class="navbar navbar-default" role="navigation">
          <div class="navbar-collapse collapse" id="nav-main">
            <ul class="nav navbar-nav">
              <li class="{{ Request::url() == route('index') ? 'active' : '' }}"><a href="{{url('/')}}"><i class="fa fa-home" style="font-size:19px;padding-right: 5px;color: #18a7ff;"></i>{{__('Home')}}</a> </li>
           ...
           <!--   <li class="mega">Menu<i class="fa fa-briefcase" style="font-size:19px;padding-right: 5px;color: #18a7ff;"></i>
              ...
              <li class="dropdown"><a href="{{route('login')}}"><i class="fa fa-user" style="font-size:19px;padding-right: 5px;color: #18a7ff;"></i>{{__('Candidate')}} <span class="caret"></span></a>
              ...
              <li class="dropdown"><a href="{{route('login')}}"><i class="fa fa-group" style="font-size:19px;padding-right: 5px;color: #18a7ff;"></i>{{__('Employer')}} <span class="caret"></span></a>
