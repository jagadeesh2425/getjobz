...
@include('includes.inner_page_seeker_title', ['page_title'=>__('Register')])
<!-- Inner Page Title end -->
<!-- <div class="reg-wrapper bg-primary">
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <p class="lead"><mark class="bg-warning">jobzware.com</mark> is the job portal for all job seekers.</p>
        <p>your dream job search ends here.</p>
        <p>Are you Struggling to get a job?</p>
        <p>Sign up with us and upload your resume , its free. </p>
