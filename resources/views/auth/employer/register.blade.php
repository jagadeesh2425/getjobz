...
@include('includes.inner_page_recruiter_title', ['page_title'=>__('Employer Registration')])
<!-- Inner Page Title end -->
<!-- <div class="reg-wrapper bg-primary">
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <p class="lead">Are you a recruiter? Register with us .</p>
        <p>You will find an exact match for your profile search.</p>
        <p>Your initial job posts are free free free<span class="text-danger">*</span></p>
      </div>
    </div>
  </div>
</div> -->
        ...
        <div class="userccount">
          <div class="userbtns">
            <ul class="nav nav-tabs">
              <?php
            $c_or_e = old('candidate_or_employer', 'employer');
			?>
